...
const { LanggraphClient } = require('~/app');

const { PROXY } = process.env;

const initializeClientGraph = async ({ req, res, endpointOption, optionsOnly, overrideEndpoint }) => {
  ...
  const client = new LanggraphClient(apiKey, clientOptions);
  return {
    client,
    openAIApiKey: apiKey,
  };
...
module.exports = initializeClientGraph;
